...
import com.shubham.snaplink.exception.PasswordRequiredException;
...
public class ShortLinkServiceImpl implements ShortLinkService {
    ...
    public String redirect(String shortCode, HttpServletRequest request) {
        ...
        // 3.5. Password Check
        if (shortLink.getPassword() != null && !shortLink.getPassword().isBlank()) {
            String providedPassword = request.getParameter("password");
            if (providedPassword == null || !providedPassword.equals(shortLink.getPassword())) {
                throw new PasswordRequiredException(shortCode, "Password required for redirection");
            }
        }
